...
4. Combines three core components:
    * Historical financial analysis to understand business performance.
    * Forward‑looking projections to estimate future results.
    * A valuation framework that converts those expectations into present value.
